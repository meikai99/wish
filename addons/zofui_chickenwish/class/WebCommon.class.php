...
{	
	...
	static function logUrl($key,$value){
		return self::commonstructUrl($key,$value,array('order','by','nowvalue','status','type'));
	}	
	...
	static function deleteSingleData($id,$tablename){		
		...
		if( $tablename == 'zofui_chickenwish_wish' ){
			$wish = pdo_get('zofui_chickenwish_wish',array('id'=>$id),array('openid'));
		}
		...
		}elseif( $tablename == 'zofui_chickenwish_prize' ){
